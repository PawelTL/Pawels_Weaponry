...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        cleaver(ModItems.STONE_CLEAVER, Items.STONE, exporter);
        ...
        dualblade(ModItems.STONE_DUAL_BLADE, Items.STONE, exporter);
        ...
        longsword(ModItems.STONE_LONGSWORD, Items.STONE, exporter);
        ...
        katana(ModItems.STONE_KATANA, Items.STONE, exporter);
        ...
        battleaxe(ModItems.STONE_BATTLEAXE, Items.STONE, exporter);
