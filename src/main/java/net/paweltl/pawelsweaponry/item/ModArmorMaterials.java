...
public enum ModArmorMaterials implements ArmorMaterial {
    JUGGERNAUT("juggernaut", 45, new int[] { 4, 9, 7, 4 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3f, 0.15f, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    BERSERKER("berserker", 35, new int[] { 2, 7, 5, 2 }, 19,
    ...
    public String getName() {
        return PawelsWeaponry.MOD_ID + ":" + this.name;
    }
